 ...
 */
function ExplosionConfetti({ position = [0, 0, 0], colorsArray = ['#452632', '#91204d', '#e4844a', '#e8bf56', '#e2f7ce'], numberOfExplosions = 2, particleAmount = 100, particleSize = 0.2, spreaAreadRadius = 5, contettiDuration = 75, explosionCount = Infinity }) {
	const ref = useRef()
